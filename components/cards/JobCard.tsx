...
const JobCard = ({ job }: { job: Job }) => {
  ...
  return (
    <section
      className="background-light900_dark200 light-border shadow-light100_darknone flex
     flex-col items-start gap-6 rounded-lg border p-6 sm:flex-row  sm:p-8
     "
    >
      ...
      <div className="flex items-center gap-6">
        {employer_logo ? (
          <Link
            ...
            className="background-light800_dark400 relative  
